                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="form-control btn btn-primary" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" Width="42px"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-9">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ELibraryDBConnectionString %>" SelectCommand="SELECT * FROM [BookTBL]"></asp:SqlDataSource>
                                    ...
                                    <ItemTemplate>
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("Book_Name") %>' Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            Author-<asp:Label ID="Label1" runat="server" Text='<%# Eval("Author_Name") %>' Font-Bold="True"></asp:Label>
                                                            &nbsp;| Genre-<asp:Label ID="Label2" runat="server" Text='<%# Eval("Genre") %>' Font-Bold="True"></asp:Label>
                                                ...
                                                <div class="col-sm-2">
                                                    <asp:Image ID="Image1" class="container-fluid" runat="server" ImageUrl='<%# Eval("Book_IMG_Link") %>' ImageAlign="Middle" />
                                                </div>
                                            </div>
                                        </div>
                                    </ItemTemplate>
